  ...
  Future<void> _submitQuiz() async {
    ...
    if (!quizProvider.validateQuiz()) {
      context.showCustomSnackBar(
        message:
            'Please ensure all questions have at least two options and a correct answer',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (quizProvider.quizQuestions.length > 1)
                        TextButton(
                          onPressed:
                              () => quizProvider.removeQuestion(
                                quizProvider.quizQuestions.length - 1,
                              ),
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: ValidationService.requiredValidation,
              onChanged:
                  (value) => quizProvider.updateQuestionText(index, value),
            ),
            SizedBox(height: 2.h),
            Text(
              'Options',
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: ValidationService.requiredValidation,
                        onChanged:
                            (value) => quizProvider.updateOption(
                              index,
                              optIndex,
                              value,
                            ),
                    ...
                    if (question.optionControllers.length > 2)
                      IconButton(
                        ...
                        onPressed:
                            () => quizProvider.removeOption(index, optIndex),
                      ),
                  ],
                ),
              );
            ...
            PopupMenuButton<String>(
              ...
              onSelected:
                  (value) => quizProvider.updateCorrectAnswer(index, value),
              itemBuilder: (context) {
                return question.optionControllers
                    .asMap()
                    .entries
